<template>
  ...
  const rydsParFront = [3, 4, 4, 3, 3, 3, 3, 5, 3];
  const rydsParBack = [3, 4, 3, 5, 3, 3, 3, 4, 3];
  const hammarenParFront = [3, 3, 3, 3, 3, 3, 3, 3, 4];
  const hammarenParBack = [3, 4, 3, 4, 3, 3, 3, 3, 3];
  // Define methods
